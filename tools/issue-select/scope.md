...
I have experience with Python, FastAPI, TypeScript, React/Next.js, pytest, and GitHub. I am currently studying Trust & Safety, so I am especially interested in safety, responsible AI, and user-facing product issues. I also have product and UX design experience and care about accessibility and clear user feedback. For my first contribution, I prefer a bounded 2–6 hour issue with reproducible behavior and testable results, and I want to avoid broad infrastructure changes, database migrations, and features that require changes across many services.
